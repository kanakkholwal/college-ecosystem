...
import {
  ...
  postVisibilities,
  WhisperPostT,
} from "$lib/constants/community.whispers";
...
export interface IWhisperPost
  extends Document, Omit<WhisperPostT, "_id" | "createdAt" | "updatedAt"> {
  createdAt: Date;
  updatedAt: Date;
...
export const WhisperPostModel: Model<IWhisperPost> =
  mongoose.models.WhisperPost ||
  mongoose.model<IWhisperPost>("WhisperPost", WhisperPostSchema);
