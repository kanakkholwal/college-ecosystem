<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				light: 'bg-white shadow text-gray-700 hover:text-gray-700 border border-border',
	...
	export type ButtonTransition = VariantProps<typeof buttonVariants>['transition'];
