    ...
    <div className="p-8 space-y-12 min-h-screen">
      <section className="max-w-6xl mx-auto" id="button">
        <header className="mb-12 sticky top-0 bg-background/80 backdrop-blur-md py-4 z-10 p-4 rounded-b-lg border-b border-border">
          ...
          <p className="text-muted-foreground mt-2 text-sm">
            A comprehensive overview of all button variants available in the
            design system.
          </p>
        </header>
        ...
        {Object.entries(variantsConfig).map(([variantType, options]) => (
          <div
            key={variantType}
            className="mb-12 p-6 rounded-lg shadow bg-card/40"
          >
      ...
      <section className="max-w-6xl mx-auto" id="badge">
        <header className="mb-12 sticky top-0 bg-background/80 backdrop-blur-md py-4 z-10 p-4 rounded-b-lg border-b border-border">
          ...
          <p className="text-muted-foreground mt-2 text-sm">
            A comprehensive overview of all badge variants available in the
            design system.
          </p>
        </header>
        <div className="flex flex-wrap gap-4 items-center">
