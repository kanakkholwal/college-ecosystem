    ...
    <div className="min-h-screen pb-24">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                Updated{" "}
                {new Date(course.updatedAt || new Date()).toLocaleDateString()}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <Tabs defaultValue={tab} className="space-y-12">
          ...
          <TabsContent
            value="curriculum"
            className="mt-0 animate-in fade-in-50 slide-in-from-bottom-4"
          >
            {chapters.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <Badge
                          variant="secondary"
                          className="bg-background border shadow-sm shrink-0 font-normal text-muted-foreground"
                        >
          ...
          <TabsContent value="resources" className="mt-0">
            ...
            <FooterAction>
              {session?.user ? (
                ...
                <AuthButton
                  label="Add Resource"
                  nextUrl={`/syllabus/${course.code}?tab=resources`}
                />
              )}
            </FooterAction>
          </TabsContent>
          ...
          <TabsContent value="papers" className="mt-0">
            ...
            <FooterAction>
              {session?.user ? (
                ...
                <AuthButton
                  label="Upload Paper"
                  nextUrl={`/syllabus/${course.code}?tab=papers`}
                />
              )}
            </FooterAction>
          </TabsContent>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h4 className="text-sm font-medium truncate pr-4 text-foreground">
          {refData.name}
        </h4>
...
function FooterAction({ children }: { children: React.ReactNode }) {
  return <div className="flex justify-center pt-8 mt-4">{children}</div>;
}
