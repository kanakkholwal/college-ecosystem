    ...
    <div className="relative min-h-screen">
      ...
      <main className="container relative z-10 mx-auto max-w-5xl px-4 py-16 md:py-24">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
          <Badge
            variant="outline"
            className="rounded-full py-1.5 px-4 border-primary/20 bg-primary/5 text-primary"
          >
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">
            ...
            <span className="bg-linear-to-l from-teal-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% bg-clip-text text-transparent">
              By Students.
            </span>
          </h1>

          <p className="text-lg text-muted-foreground leading-relaxed">
            <strong>nith.eu.org</strong> is an open-source operating system for
            the NIT Hamirpur community. We bridge the gap between academic
            resources and student life through modern technology.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                This platform is an <strong>independent initiative</strong>. We
                are not affiliated with, endorsed by, or officially representing
                the <strong>National Institute of Technology, Hamirpur</strong>.
                All institute trademarks belong to their respective owners.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We believe information should be accessible, and student tools
              should be delightful to use. Our goal is to replace outdated
              systems with a unified, transparent ecosystem.
            </p>

            <div className="space-y-4">
              <FeatureRow Icon={Users} title="Community First">
                Empowering collaboration through shared resources and open
                communication channels.
              </FeatureRow>
              <FeatureRow Icon={Code2} title="Open Source">
                Complete transparency. Our code is open for anyone to audit,
                improve, or learn from.
              </FeatureRow>
              <FeatureRow Icon={HeartHandshake} title="Student Utility">
                Solving real problems—from finding a syllabus to checking
          ...
          <div className="bg-muted/30 border border-border/50 rounded-2xl p-6 flex flex-col items-center justify-center min-h-[300px]">
            <span className="text-xs font-mono text-muted-foreground/50 mb-4 uppercase tracking-widest">
              Sponsored
            </span>
        ...
        <div className="text-center max-w-2xl mx-auto space-y-6">
          <p className="text-sm text-muted-foreground italic">
            {'"'}The goal is not to replace the institute{"'"}s authority, but
