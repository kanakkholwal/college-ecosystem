      ...
      <main className="container relative z-10 mx-auto max-w-7xl px-4 py-12 md:py-20">
        ...
        <div className="mb-16 max-w-3xl">
          <div className="flex items-center gap-2 mb-4">
            <Badge
              variant="outline"
              className="rounded-full py-1 border-primary/20 bg-primary/5 text-primary"
            >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <strong> nith.eu.org</strong> and <strong>app.nith.eu.org</strong>{" "}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 prose prose-zinc dark:prose-invert max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
            <section id="intro">
              <h2>Who We Are</h2>
              <p>
                We are a student-run platform providing resources and tools for
                the NIT Hamirpur community. We are not officially affiliated
                with NIT Hamirpur. Contact us at{" "}
              ...
              <p>
                ...
                , and any related pages, tools, or APIs that link to this
                Policy.
              </p>
            </section>
            ...
            <section id="collection">
              ...
              <div className="grid sm:grid-cols-2 gap-4 not-prose">
                <InfoCard title="Usage & Device Data">
                  IP address, location (city/region), device type, pages viewed,
                  and timestamps.
                </InfoCard>
                <InfoCard title="Cookies">
                  Identifiers to remember preferences, session state, measure
                  traffic, and serve ads.
                </InfoCard>
                <InfoCard title="Account Data">
                  Name, email, roll number (if provided), community posts, and
                  uploaded files.
                </InfoCard>
                <InfoCard title="Security Signals">
                  Logs and events used to detect fraud, abuse, or system
                  outages.
                </InfoCard>
              </div>
            </section>
            ...
            <section id="usage" className="mt-8">
              ...
              <ul>
                ...
                <li>
                  Provide features (e.g., results lookup, resources,
                  communities).
                </li>
                ...
                <li>
                  Monetize via advertising and/or affiliate links (where
                  enabled).
                </li>
              </ul>
            </section>
            ...
            <section id="cookies">
              ...
              <p>
                We use first-party and third-party cookies, pixels, and local
                storage for functionality, analytics, and advertising.
              </p>
              ...
              <div className="bg-muted/30 p-6 rounded-xl border border-border/50 not-prose my-6">
                ...
                <ul className="text-sm text-muted-foreground space-y-2 list-disc pl-4">
                  ...
                  <li>
                    Google’s advertising cookies enable it and its partners to
                    serve ads to you based on your visits to our sites and/or
            ...
            <section id="analytics">
              ...
              <h3>Analytics</h3>
              <p>
                We may use privacy-respecting analytics and/or mainstream tools
                to understand traffic and usage. These may set cookies or
                collect pseudonymous identifiers and event data. Where feasible,
                we minimize or aggregate metrics.
              </p>

              <h3>Affiliate Links</h3>
              <p>
                Some outbound links may be affiliate links. If you click an
            ...
            <section id="rights">
              ...
              <p>
                If you are in the EEA/UK, we process data based on{" "}
                <strong>Contract</strong> (to provide services),{" "}
                <strong>Legitimate Interests</strong> (security/improvement),{" "}
                <strong>Consent</strong> (ads/cookies), and{" "}
                <strong>Legal Obligation</strong>.
              </p>
              <h3>Your Choices</h3>
              <ul>
                <li>
                  <strong>Cookie controls:</strong> Manage via browser settings
                  or opt-out links.
                </li>
                <li>
                  <strong>Access/Delete:</strong> Request a copy or deletion of
                  your data (subject to legal exceptions).
                </li>
                <li>
                  <strong>Withdraw Consent:</strong> You can withdraw previously
            ...
            <section id="security">
              ...
              <p>
                ...
                partners, and for legal compliance. We retain data only as long
                as necessary. While we use reasonable security measures, no
                online transmission is 100% secure.
              </p>
              <h3>International Transfers</h3>
              <p>
                We may process and store information in countries other than
                yours. We use lawful transfer mechanisms as required.
              </p>
            </section>
            ...
            <div className="mt-12 p-4 bg-muted/50 border-l-4 border-amber-500 rounded-r-md not-prose">
              <p className="text-sm text-muted-foreground italic">
                <strong>Disclaimer:</strong> This platform is unofficial and not
                affiliated with the National Institute of Technology, Hamirpur.
                Names or marks remain the property of their respective owners.
              </p>
            </div>
