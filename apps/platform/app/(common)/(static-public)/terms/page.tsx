      ...
      <main className="container relative z-10 mx-auto max-w-7xl px-4 py-12 md:py-20">
        ...
        <div className="mb-16 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            By accessing <strong>nith.eu.org</strong> or{" "}
            <strong>app.nith.eu.org</strong>, you agree to the following terms.
          ...
          <article className="flex-1 prose prose-zinc dark:prose-invert max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-base font-semibold text-foreground mb-1">
                    Unofficial Platform Disclaimer
                  </h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    This is a <strong>student-run project</strong>. We are NOT
                    affiliated with, endorsed by, or representing the{" "}
                    <strong>National Institute of Technology, Hamirpur</strong>.
                    All academic data is for informational purposes only.
                  </p>
                </div>
              </div>
            </div>
            ...
            <section id="acceptance">
              ...
              <p>
                ...
                these Terms, our Privacy Policy, and any other guidelines we may
                post. If you do not agree, you must discontinue use immediately.
              </p>
            </section>
            ...
            <section id="unofficial">
              ...
              <p>
                We expressly disclaim any official representation of NIT
                Hamirpur. All trademarks, logos, and institute names mentioned
                belong to their respective owners and are used solely for
            ...
            <section id="usage">
              ...
              <ul>
                <li>
                  Misuse, hack, interfere with, or disrupt our infrastructure.
                </li>
                <li>
                  Upload illegal, abusive, defamatory, or infringing content.
                </li>
                <li>Scrape data without express permission.</li>
              </ul>
              <p>
                You maintain responsibility for any content you submit to
                community sections.
              </p>
            </section>
            ...
            <section id="academic">
              ...
              <p>
                ...
                convenience only.
                <strong> We do not guarantee real-time accuracy.</strong> You
                are responsible for verifying critical academic data with
                official institute sources.
              </p>
            </section>
            ...
            <section id="accuracy">
              ...
              <p>
                ...
                warranties regarding the completeness, reliability, or
                availability of the content. We are not liable for errors or
                omissions.
              </p>
            </section>
            ...
            <section id="ads">
              ...
              <p>
                Our Site includes third-party advertising (e.g., Google AdSense)
                and affiliate links. We may earn commissions on clicks or
                purchases. We do not endorse products advertised by third
                parties.
              </p>
            ...
            <section id="liability">
              ...
              <p>
                To the fullest extent permitted by law, the operators of
                nith.eu.org shall not be liable for any direct, indirect,
            ...
            <section id="indemnification">
              ...
              <p>
                You agree to indemnify and hold harmless the platform operators
                and contributors from any claims arising out of your violation
                of these Terms.
              </p>
            </section>
            ...
            <section id="ip">
              ...
              <p>
                Original content created by us (code, designs, guides) is
                protected. You may not reproduce or distribute our proprietary
            ...
            <div className="mt-12 not-prose border-t border-border pt-8">
              <p className="text-sm text-muted-foreground italic">
                <strong>Final Disclaimer:</strong> Use of the Site is at your
                own risk. Always confirm official academic information with the
                institute.
              </p>
            </div>
          </article>
