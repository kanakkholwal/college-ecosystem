...
export default async function StoryDetailPage({
  ...
  const story = {
    ...
    **Round 2: Technical Interview**
    ...
    resources: [
      { title: "Striver SDE Sheet", url: "#" },
      { title: "NeetCode 150", url: "#" },
    ],
      ...
      <div className="max-w-(--max-app-width) mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          <div className="flex flex-wrap gap-3 mb-4">
            <Badge variant="default_soft">{story.offerType}</Badge>
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground mb-4 leading-tight">
            {story.role} <span className="text-muted-foreground">at</span>{" "}
            {story.companyName}
          </h1>
        ...
        <div className="grid md:grid-cols-[1fr_280px] gap-12">
            ...
            {story.resources.length > 0 && (
              <section className="bg-card border rounded-2xl p-6 shadow-sm">
                <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                  <PiLinkDuotone className="text-primary h-5 w-5" /> Recommended
                  Resources
                </h3>
          ...
          <aside className="space-y-6">
            <Card className="p-6 sticky top-24 shadow-sm border-primary/20 bg-primary/5">
              <h3 className="font-semibold mb-6 text-xs uppercase tracking-widest text-muted-foreground">
                Offer Snapshot
              </h3>
