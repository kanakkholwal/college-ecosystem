      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Curated collection of free software, tools, and discounts
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          {benefitsCategories.map((cat, index) => {
            const tabBenefits = filteredBenefits.filter(
              ...
              <TabsContent key={cat} value={cat} className="mt-0">
                {tabBenefits.length === 0 ? (
                  ...
                  <div className="space-y-12">
                    {/* Render Correct View */}
                    {viewMode === "grid" && (
                      <BenefitsGrid tabBenefits={tabBenefits} />
                    )}
                    {viewMode === "horizontal" && (
                      <BenefitsGridHorizontal tabBenefits={tabBenefits} />
                    )}
                    {viewMode === "minimal" && (
                      <BenefitsGridMinimal tabBenefits={tabBenefits} />
                    )}
        ...
        <div className="mt-20 text-center bg-muted/30 border border-border/50 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            Help the community grow by submitting new student benefits. We
            review all submissions within 24 hours.
          </p>
          <ButtonLink
        ...
        >
          ...
          <div className="p-5 flex items-start justify-between border-b border-border/40 bg-muted/20">
            ...
            {res.isNew && (
              <Badge
                variant="default"
                className="h-5 px-1.5 text-[10px] bg-emerald-500/10 text-emerald-600 border-emerald-500/20 hover:bg-emerald-500/20"
              >
                NEW
              </Badge>
            )}
          ...
          <div className="p-5 flex-1 flex flex-col">
            ...
            <div className="mt-auto flex flex-wrap gap-2">
              {res.value && (
                <Badge
                  variant="secondary"
                  className="font-medium bg-primary/5 text-primary border-primary/10"
                >
                  {res.value} Value
                </Badge>
              )}
...
export function BenefitsGridHorizontal({
  tabBenefits,
}: {
  tabBenefits: benefitsItem[];
}) {
  return (
...
export function BenefitsGridMinimal({
  tabBenefits,
}: {
  tabBenefits: benefitsItem[];
}) {
