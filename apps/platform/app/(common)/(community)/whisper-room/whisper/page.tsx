              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <h1 className="text-sm font-semibold flex items-center gap-2">
                    New Whisper{" "}
                    <span className="text-[10px] font-normal text-muted-foreground bg-muted px-1.5 rounded">
                      BETA
                    </span>
                  </h1>
                </div>
          ...
          <main className="w-full px-4 grid grid-cols-1 lg:grid-cols-12 gap-8">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <div className="flex items-center gap-2">
                            ...
                            >
                              Hide voter identity (Anonymous Voting)
                            </Label>
                          </div>
                        )}
                      />
                      ...
                      <div className="space-y-2">
                        {fields.map((field, index) => (
                          <div key={field.id} className="flex gap-2">
                            <Input
                              {...form.register(
                                `poll.options.${index}.text` as const
                              )}
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/10 text-amber-600/80 text-xs leading-relaxed flex gap-3">
                ...
                <p>
                  <strong>Community Guidelines:</strong> Even when anonymous,
                  hate speech, harassment, and threats are not tolerated. We use
                  basic moderation to keep the campus safe.
                </p>
              </div>
            </div>
          </main>
