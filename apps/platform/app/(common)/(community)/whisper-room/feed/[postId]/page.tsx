...
import {
  getWhisperPostById,
  updateWhisperPoll,
} from "~/actions/community.whisper";
...
export default async function WhisperFeedPage({
  ...
  const avatarSrc =
    isPseudo && whisper.pseudo?.avatar
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-8">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2">
                    ...
                    {isAnonymous && (
                      <Badge
                        variant="secondary"
                        className="text-[10px] h-5 px-1.5 bg-muted/50 text-muted-foreground border-border/50"
                      >
        ...
        <div className="rounded-xl border border-dashed border-border/60 bg-muted/20 p-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1 max-w-xs mx-auto">
            To maintain the safety and anonymity of the Whisper Room, direct
