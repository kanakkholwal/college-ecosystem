...
export default function EditWhisperPostClient({
  post,
}: {
  post: WhisperPostT;
}) {
          ...
          <main className="w-full px-4 grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/10 text-amber-600/80 text-xs leading-relaxed flex gap-3">
                ...
                <p>
                  <strong>Note:</strong> Changing visibility on an existing post
                  will update how it appears in the feed, but previous reactions
                  remain attached to the post ID.
                </p>
              </div>
            </div>
          </main>
