...
import { Ghost, MessageSquarePlus, Podcast, Sparkles } from "lucide-react";
...
export default function WhisperFeedClient({
  whispers,
}: {
  whispers: WhisperPostT[];
}) {
                  ...
                  <div className="p-8 rounded-2xl border border-dashed border-border/60 bg-muted/20">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-sm text-muted-foreground max-w-md mx-auto mb-4">
                        The Whisper Room is waiting for your story. Anonymous,
                        safe, and heard.
                      </p>
                      <Button
                        variant="outline"
