...
export default function ImportNewStudents() {
  ...
  const handleFileChange = async (
    ...
    try {
      ...
      headerRow.forEach((h) => {
        ...
        if (lower.includes("roll") || lower.includes("id"))
          newMapping.rollNo = h;
  ...
  const processedData = useMemo(() => {
    if (!columnMapping.name || !columnMapping.rollNo || !columnMapping.gender)
      return [];
  ...
  const isMappingComplete = SYSTEM_FIELDS.every(
    ...
    <div className="max-w-4xl mx-auto space-y-8 p-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Bulk upload student records. Map your Excel columns to the system
          fields below.
        </p>
      </div>
          ...
          {file && (
            <Card>
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  Match your Excel headers to system fields
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 p-4">
                {SYSTEM_FIELDS.map((field) => (
                  <div
                    key={field.key}
                    className="grid grid-cols-1 sm:grid-cols-3 items-center gap-2 sm:gap-4"
                  >
        ...
        <div className="space-y-6">
          <Card className="h-full flex flex-col">
            <CardHeader>
              ...
              <CardDescription>
                First 5 rows with applied mapping
              </CardDescription>
            </CardHeader>
              ...
              <ScrollArea className="h-[300px] w-full border-y">
                {processedData.length > 0 ? (
                        ...
                        <TableRow key={i}>
                          ...
                          <TableCell>
                            ...
                            {row.gender === "female" && (
                              <Badge
                                variant="secondary"
                                className="text-[10px] bg-pink-100 text-pink-700 hover:bg-pink-100"
                              >
                                F
                              </Badge>
                            )}
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-muted-foreground p-8 text-center">
                    ...
                    <p className="text-sm">
                      Upload a file and map columns to see preview
                    </p>
                  </div>
                )}
              </ScrollArea>
