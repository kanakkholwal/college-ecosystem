...
import { ChartBar, RoundedPieChart } from "@/components/application/charts";
  ...
  return (
    <div className="space-y-6 my-5 pr-2">
        ...
        <div className="grid grid-cols-1 @xl:grid-cols-2 gap-2">
          {[
...

            {
              ...
              growthPercent: 0,
              icon: (
                <Badge size="sm" variant="default_soft" className="">
      ...
      <div className="w-full grid grid-cols-1 @lg:grid-cols-2 @4xl:grid-cols-12 gap-4 pr-1.5 @4xl:pr-0">
        ...
        <StatsCard
          className="col-span-1  @4xl:col-span-6"
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">Total Users by Gender</p>
        </StatsCard>
        ...
        >
          <RoundedPieChart
            ...
            config={{
              ...ROLES.reduce<Record<string, { label: string; color: string }>>(
                (acc, role, idx) => {
                  acc[role] = {
            ...
            nameKey="role"
          />
          <p className="text-xs text-muted-foreground">Total Users per Role</p>
        </StatsCard>
          ...
          <RoundedPieChart
            ...
            config={{
              ...
              >((acc, dept, idx) => {
                acc[dept.code] = {
                  label:
                    getDepartmentName(dept.code) ??
                    changeCase(dept.code, "title"),
                  color: `var(--chart-${idx + 1})`,
                };
                return acc;
              }, {}),
