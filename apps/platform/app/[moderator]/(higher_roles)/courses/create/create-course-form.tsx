...
export function CreateCourseForm({ moderator }: { moderator: string }) {
  ...
  const handleSaveAcceptedCourses = async () => {
    ...
    const coursesToSave = generatedCourses.filter((_, i) =>
          ...
          >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define the core attributes of the new course.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Set credits, type, and learning objectives.
                </CardDescription>
              </CardHeader>
      ...
      <TabsContent value="import" className="mt-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload a curriculum PDF or syllabus image to automatically extract
              course details.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-semibold flex items-center gap-2">
                    ...
                    <span className="bg-secondary text-secondary-foreground text-[10px] px-2 py-0.5 rounded-full">
                      {acceptedIndices.length} / {generatedCourses.length}{" "}
                      Selected
                    </span>
                  </h3>
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={() =>
                        setAcceptedIndices(
                          Array.from(
                            { length: generatedCourses.length },
                            (_, i) => i
                          )
                        )
                      }
                      ...
                      >
                        ...
                        <div className="text-xs text-muted-foreground pl-7 border-l-2 ml-2.5 space-y-1">
                          ...
                          {course.outcomes.length > 2 && (
                            <p className="italic">
                              + {course.outcomes.length - 2} more outcomes
                            </p>
                          )}
                        </div>
                      </div>
                ...
                <div className="flex justify-end pt-6">
                  ...
                  >
                    ...
                    {saving
                      ? " Saving..."
                      : `Import ${acceptedIndices.length} Courses`}
                  </Button>
                </div>
              </div>
            )}
