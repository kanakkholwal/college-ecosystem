...
const timeline = [
  {
    day: "01-02",
    title: "Ideation & Teaming",
    description:
      "Lock in your squad. Brainstorm constraints. Finalize the problem statement.",
  },
  {
    day: "03-07",
    title: "The Build Sprint",
    description:
      "Heads down coding. MVP focus. Daily standups and mentor unblocking sessions.",
  },
  {
    day: "08-09",
    title: "Polish & Pitch",
    description:
      "UI/UX cleanup. Bug bashing. Preparing the pitch deck and demo flow.",
  },
  {
    day: "10",
    title: "Demo Day",
    description:
      "Live presentations to investors and judges. Networking mixer.",
  },
];
const programConfig = {
  name: "Builder Club",
  description:
    "Join the Builder Club at NITH to build real projects with peers.",
  heroVideo:
    "https://vin9ofcd7b.ufs.sh/f/cp3W6Ixy53KeGfTmPhVk2lCKH03abZPYxMTh6QURgN7DAXm8",
} as const;
    ...
    <div className="min-h-screen">
      ...
      <section className="relative w-full min-h-[90vh] flex flex-col justify-center items-center overflow-hidden border-b border-border">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <Badge
            variant="outline"
            className="mb-6 px-4 py-1.5 text-sm bg-muted/50 text-muted-foreground backdrop-blur-sm rounded-full border-border"
          >
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            <span className="text-foreground font-semibold">Build House</span>{" "}
            is a 10-day intensive engineering sprint. No fluff. No theory. Just
            15 selected builders shipping real products.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <ButtonLink
              variant="outline"
              size="lg"
              className="h-12 px-8 text-base rounded-full bg-transparent hover:bg-muted"
              href="#manifesto"
            >
              Read Manifesto
            </ButtonLink>
          ...
          <div className="mt-20 flex justify-center gap-8 text-muted-foreground/60">
            <div className="flex items-center gap-2 hover:text-foreground transition-colors">
              <Terminal size={20} /> <span>Shipping Code</span>
            </div>
            <div className="flex items-center gap-2 hover:text-foreground transition-colors">
              <Users size={20} /> <span>15 Builders</span>
            </div>
            <div className="flex items-center gap-2 hover:text-foreground transition-colors">
              <Trophy size={20} /> <span>₹5k Prizes</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                <p>
                  Most colleges teach you how to write code. We teach you how to{" "}
                ...
                <p>
                  Build House provides the high-agency environment missing from
                  traditional education. You get 24/7 access to the house,
                  unlimited coffee, premium AI tools, and mentorship from
                  founders who have actually exited.
                </p>
                <ul className="grid grid-cols-2 gap-4 pt-4">
                  <li className="flex items-center gap-2 text-sm font-medium text-foreground">
                    <CheckIcon /> 10 Days On-site
                  </li>
                  <li className="flex items-center gap-2 text-sm font-medium text-foreground">
                    <CheckIcon /> Zero Equity Taken
                  </li>
                  <li className="flex items-center gap-2 text-sm font-medium text-foreground">
                    <CheckIcon /> Full Scholarship
                  </li>
                  <li className="flex items-center gap-2 text-sm font-medium text-foreground">
                    <CheckIcon /> Merch & Swag
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              We remove every friction point so you can focus on one thing:
              Building.
            </p>
          </div>
          ...
          <div className="relative rounded-[2rem] border border-border bg-card/50 backdrop-blur-xl overflow-hidden p-8 md:p-16 text-center">
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed">
                Don&apos;t let your ideas rot in a Notion doc. Join the
                high-agency environment where builders become founders.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
                <ButtonLink
                  size="lg"
                  className="h-14 px-8 rounded-full text-base font-bold shadow-lg shadow-primary/20"
                  href="builder-club/apply-now"
                >
                ...
                <ButtonLink
                  ...
                  size="lg"
                  disabled
                  className="h-14 px-8 rounded-full text-base bg-background/50 hover:bg-background border-primary/20 hover:border-primary/50 transition-all"
                  href="/waitlist"
                >
                  Join Waitlist{" "}
