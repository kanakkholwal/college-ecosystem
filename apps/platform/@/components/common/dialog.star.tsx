        ...
        <div className="relative w-full bg-card overflow-hidden rounded-2xl -mt-4">
          ...
          <div className="relative z-10 flex flex-col items-center pt-12 pb-8 px-8 text-center">
            ...
            <p className="text-muted-foreground mb-8 font-medium leading-relaxed text-left">
              Building this platform takes time and effort. A star on GitHub
              costs you nothing, but it helps us grow and stay motivated!
            </p>
            {/* Actions */}
...
const CuteOctopus = () => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g transform="rotate(10, 100, 100)">
      {/* Tentacles */}
      <path
        d="M60 140 C 40 160, 40 180, 60 190"
        stroke="#A78BFA"
        strokeWidth="12"
        strokeLinecap="round"
      />
      <path
        d="M85 145 C 80 170, 90 190, 100 195"
        stroke="#A78BFA"
        strokeWidth="12"
        strokeLinecap="round"
      />
      <path
        d="M115 145 C 130 170, 120 190, 110 195"
        stroke="#A78BFA"
        strokeWidth="12"
        strokeLinecap="round"
      />
      <path
        d="M140 140 C 160 160, 160 180, 140 190"
        stroke="#A78BFA"
        strokeWidth="12"
        strokeLinecap="round"
      />
      ...
      {/* Body */}
      <path
        d="M50 100 C 50 40, 150 40, 150 100 C 150 140, 50 140, 50 100"
        fill="#C4B5FD"
        stroke="#8B5CF6"
        strokeWidth="4"
      />
      ...
      {/* Holding Heart */}
      <path
        d="M30 110 C 10 90, 50 60, 50 100"
        fill="#FB7185"
        stroke="#E11D48"
        strokeWidth="2"
        transform="translate(10, 20) scale(0.8) rotate(-20)"
      />
    </g>
  </svg>
);
